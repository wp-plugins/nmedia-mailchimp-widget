			...
			<div class="col-6-12">
				...
				<div class="nm-inner">
					<table style="width:100%; ">
						...
						<tr>
							<td><label for="heading">Header Text</label></td>
							<td><input type="text" id="heading" ng-model="subForm.headerText"></td>
						</tr>
						<tr>
							<td><label for="headerBg">Header Background Color</label></td>
							<td><input type="text" class="colorpicker" id="headerBg" ng-model="subForm.headerBg"></td> 
						</tr>
						<tr>
							<td><label for="headerTextColor">Font Color</label></td>
							<td> <input type="text" class="colorpicker" id="headerTextColor" ng-model="subForm.headerTextColor"></td>
						</tr>
					</table>
					...
					<table style="width:100%; ">
						<tr>
							<td><label for="sectionBackgroundColor">Section Background</label></td>
							<td><input type="text" class="colorpicker" id="sectionBackgroundColor" ng-model="subForm.sectionBackgroundColor"></td> 
						</tr>
					</table>
					...
					<table style="width:100%; ">
						<tr>
							<td><label for="footertext">Button Lable Text</label></td>
							<td><input type="text" id="footertext" ng-model="subForm.buttonlable"></td>
						</tr>
						<tr>
							<td><label for="buttonFontColor">Button Lable Font Color</label></td>
							<td> <input type="text" class="colorpicker" id="buttonFontColor" ng-model="subForm.buttonFontColor"></td>
						</tr>
						<tr>
							<td><label for="btnBackground">Button Background Color</label></td>
							<td><input type="text" class="colorpicker" id="btnBackground" ng-model="subForm.btnBackground"></td> 
						</tr>						
						<tr>
							<td><label for="footerBg">Footer Background Color</label></td>
							<td><input type="text" class="colorpicker" id="footerBg" ng-model="subForm.footerBg"></td> 
						</tr>
					</table>
