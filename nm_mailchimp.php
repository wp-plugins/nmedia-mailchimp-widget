...
Plugin URI: http://www.najeebmedia.com/mailchimp-wordpress-plugin-by-nmedia/
...
class nmMailChimp extends WP_Widget {
	...
	*/	 
	...
	static $widgetWidth = array('150px', '160px', '170px', '180px', '190px', '200px');
  ...
  /**
	...
	function widget($args, $instance) {
		...
		nmMailChimp::nm_load_form(	$instance['nm_mc_list_id'], 
									...
									$instance['nm_mc_bg'],
									$instance['nm_mc_width'],
									$instance['nm_mc_box_title'],
									$instance['nm_mc_thanks']);
	...
	function form($instance) {
		$default = 	array( 'nm_mc_title' 		=> __('MailChimp Widget'),
						   ...
						   'nm_mc_list_id' 		=> __('0'),
						   'nm_mc_width' 		=> __('180px'),
						   'nm_mc_show_names' 	=> __('0'),
						   'nm_mc_bg' 			=> __('bg-blue.png'),
						   'nm_mc_thanks'		=> __('Thanks for your subscription, we will take care of you'));
		...
		$field_id_width = $this->get_field_id('nm_mc_width');
		$field_name_width = $this->get_field_name('nm_mc_width');
		...
		$field_id_thanks = $this->get_field_id('nm_mc_thanks');
		$field_name_thanks = $this->get_field_name('nm_mc_thanks');
  ...
  function nm_load_form($list_id, $show_names, $bgbox, $width, $boxTitle, $thanksMessage)
  {
